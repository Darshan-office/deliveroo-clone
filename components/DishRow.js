...
import { addToBasket, removeFromBasket, selectBacketItemsWithId } from '../features/basketSlice';
...
const DishRow = ({
    ...
    const items = useSelector((state) => selectBacketItemsWithId(state, id))
            ...
            {isPressed && (
                <View className={'bg-white px-4'}>
                    <View className={'flex-row items-center space-x-2 pb-3'} >
                        ...
                        <Text color="#00CCBB">{items.length}</Text>
