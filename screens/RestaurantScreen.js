...
import { StarIcon, LocationMarkerIcon, ChevronRightIcon } from 'react-native-heroicons/solid'
    ...
    return (
        <ScrollView>
            <View>
                ...
                <TouchableOpacity className={'absolute top-14 left-5 pt-3 pb-3 pl-2.5 pr-2.5 bg-gray-100  rounded-full'} onPress={navigation.goBack}>
